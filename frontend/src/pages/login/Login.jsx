...
const Login = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center h-screen min-w-96 mx-auto'>
            ...
            <form onSubmit={handleSubmit}>
                <div>
                    <label className='label p-2'>
                        <span className='label-base label-text'>Username</span>
                    </label>
                ...
                <div>
                    <label className='label'>
                            <span className='label-base label-text'>Password</span>
                    </label>
                    <input type='password' placeholder='Enter your password' className='w-full input input-bordered h-10 '
                    value={password} 
                    onChange={(e) => setPassword(e.target.value)}/>
                </div>
                <Link to={'/signup'} href='#' className='text-sm hover:underline hover:text-orange-700 mt-2 inline-block'>
